                    ...
                    {WORD_CARD_DATA.map(word => {
                        ...
                        return (
                            <button 
                                ...
                                className={`relative cursor-pointer w-[120px] sm:w-[130px] md:w-[150px] aspect-[2/3] rounded-lg shadow-md flex items-center justify-center p-1 touch-manipulation transition-all duration-200 hover:scale-105 hover:shadow-xl ${
