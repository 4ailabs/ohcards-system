                ...
                {WORD_CARD_DATA.map(word => {
                    ...
                    return (
                        <div 
                            ...
                            className={`relative cursor-pointer aspect-[2/3] rounded-lg shadow-md flex items-center justify-center p-2 transition-all duration-200 hover:scale-105 hover:shadow-xl ${
