            ...
            <div className="bg-white/90 backdrop-blur-md rounded-2xl shadow-xl p-4 sm:p-6 mb-4 sm:mb-6">
                ...
                <div className="text-center">
                    <p className="text-sm text-gray-600">
                        Progreso: {completedPairs.length} de {numberOfPairs} pares completados
                    </p>
                </div>
            </div>
                    ...
                    {Array.from({ length: numberOfPairs }, (_, i) => {
                        ...
                        return (
                            <button
                                ...
                                className={`p-4 sm:p-6 rounded-lg text-center transition-all duration-200 shadow-lg hover:scale-105 ${
                                    isCompleted
                                        ? 'bg-green-100 text-green-800 cursor-not-allowed'
                                        : 'bg-blue-100 text-blue-800 hover:bg-blue-200'
                                }`}
                            >
                                <div className="font-bold text-sm sm:text-base mb-1">Par {i + 1}</div>
